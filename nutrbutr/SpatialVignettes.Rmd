...
# This code prepares my boundaries object, alligns coordinate system, and 
...
for (f in filenames[1]){
  ...
  contents  <- nutrbutr::evaluate_polygon_contents_by_chunks(low_res,kern.boundaries.t.major, 100)
